    ...
    inheritance: {
        ...
        steps: {
            ...
            4: {
                ...
                tips: "遺產分割協議書是整件繼承案的核心文件，必須全體繼承人蓋印鑑章，印文必須極為清晰，且需與印鑑證明上的圖樣百分之百吻合。協議書正本需依契約金額的千分之一黏貼印花稅票。特別注意事項 - 未辦保存登記建物（無建物所有權狀之房屋）：若遺產包含未辦保存登記建物，應至房屋所在地之地方稅稽徵機關辦理「房屋稅納稅義務人名義變更」，並檢附 (1)遺產稅免稅/繳清證明書 (2)繼承系統表 (3)遺產分割協議書 (4)法院核備拋棄繼承證明書。"
            },
            5: {
                title: "第五階段：地方稅查欠",
                shortTitle: "地方稅查欠",
