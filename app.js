    ...
    inheritance: {
        ...
        steps: {
            1: {
                ...
                time: "1 - 3 工作天",
                agency: "戶政事務所、地政士事務所",
                desc: "與繼承人詳細面談諮詢，釐清被繼承人之家族關係，並確認全體繼承人狀況（包含未成年子女及法定代理人）。地政士會開始繪製「繼承系統表」草稿，清查被繼承人死亡除戶資料及全體繼承人現戶戶籍資料，確認有無涉外或大陸繼承人，並評估是否辦理「拋棄繼承」、「限定繼承（開列遺產清冊向法院陳報）」，或因未成年子女與父母共同繼承利益衝突而需「聲請法院選任特別代理人」。",
                docs: [
                    "被繼承人死亡登記謄本 (除戶戶籍謄本)",
                    "死亡證明書正本 (申請除戶時使用)",
                    "被繼承人戶口名簿正本",
                    "生存配偶身分證影本及照片 (配偶若隨同申辦換證需照片1張)",
                    "全體繼承人現戶戶籍謄本 (記事欄不可省略)",
                    "繼承系統表草稿",
                    "法院拋棄繼承准予備查函 (若有繼承人拋棄繼承者需附)",
                    "法院開列遺產清冊/限定繼承准予備查裁定書 (若繼承人向法院陳報限定繼承者需附)",
                    "法院選任特別代理人民事裁定書及確定證明書 (未成年子女與法定代理人共同辦理分割繼承者必備)"
                ],
                tips: "【特別提醒：拋棄繼承、限定繼承與未成年特別代理人】\n1. 拋棄繼承：必須在「知悉得繼承之時起三個月內」以書面向法院提出聲請，逾期即喪失權利。\n2. 限定繼承（陳報遺產清冊）：我國民法第1148條已實施全面法定限定繼承（以所得遺產為限負清償責任），繼承人得於「知悉得繼承之時起三個月內」開列遺產清冊陳報被繼承人住所地法院（民法第1156條）。法院公告公示催告期間不得對任何債權人償還債務，期限屆滿後始依比例清算。若繼承人隱匿遺產或未經公示催告私下清償致損害其他債權人，需負損害賠償責任甚至喪失限定繼承權益（民法第1163條）。\n3. 未成年子女聲請特別代理人：當繼承人中有未成年子女，且該未成年子女與其法定代理人（如母或父）同為繼承人並擬簽署「遺產分割協議書」時，因雙方在法律上屬「利益相反/利害關係衝突」（民法第1086條第2項），法定代理人依法不得代表未成年子女簽署協議。必須向家事法院聲請選任「特別代理人」（通常為無利害關係之祖父母、伯叔舅等親屬），代表該未成年子女簽章辦理分割。特別代理人聲請時，擬分割取得之遺產價值原則上不可低於該未成年子女之「法定應繼分」。若僅辦理「公同共有」或「按應繼分分別共有」繼承登記，因無利益衝突，則不需選任特別代理人，得由法定代理人直接代理。"
            },
            2: {
                ...
                docs: [
                    ...
                    "土地及建物第一類登記謄本",
                    "當期房屋評定現值證明 / 地價證明",
                    "繼承人與被繼承人關係證明文件 (如戶籍謄本、戶口名簿等)",
                    "委託代理人委任書及代理人身分證正本 (若委託地政士申辦)"
                ],
                tips: "謄本必須申請「第一類謄本」，以取得完整的所有權人身分證字號與記事欄。生存配偶於法定財產制關係消滅後（如配偶死亡），得主張行使民法第1030條之1『剩餘財產差額分配請求權』，此請求權在申報遺產稅時可做為扣除額以達合法節稅。此外，民法規定繼承人不分性別男女均有繼承遺產之權利，實務辦理時應落實性別平等權利。"
            },
            3: {
                ...
                desc: "依據清查的財產清單填寫遺產稅申報書。地政士會精算各項免稅額、扣除額（如配偶扣除額、直系血親卑親屬扣除額、辦理喪葬費扣除等）以合法節稅。向國稅局申報遺產稅後，若有稅款則協助完成繳納，最終取得「遺產稅繳清證明書」或無稅時取得「遺產稅免稅證明書」。",
                docs: [
                    "遺產稅申報書",
                    "國稅局核發之「遺產稅免稅證明書」或「遺產稅繳清證明書」正本及影本",
                    "或國稅局核發之「不計入遺產總額證明書」或「同意移轉證明書」(視案件情況)",
                    "遺產稅申報相關身分與財產評估文件"
                ],
                tips: "遺產稅申報的法定時限為「被繼承人死亡之次日起六個月內」，逾期申報會被處以罰鍰。若因尋找繼承人、財產複雜等正當理由無法按時申報，可於期滿前向國稅局聲請展延三個月。依遺產及贈與稅法第8條規定，遺產稅未繳清前（或未取得免稅、不計入總額、同意移轉等證明前），不得分割遺產、交付遺贈或辦理移轉登記。"
            },
            4: {
                title: "第四階段：分割協議與印鑑證明",
                shortTitle: "分割協議與印鑑證明",
                time: "2 - 5 工作天",
                agency: "全體繼承人住所、戶政事務所、家事法院",
                desc: "繼承人可協議將財產不按法定應繼分分配（例如由其中一人繼承特定土地，其他人繼承現款或不分配）。此時必須撰寫「遺產分割協議書」，由全體繼承人親自簽名並蓋「印鑑章」。若繼承人當中有未成年子女且與法定代理人同為繼承人，應由法院裁定選任之「特別代理人」代表該未成年子女於分割協議書簽章並蓋印鑑章。各繼承人及特別代理人均須檢附戶政事務所申請之「印鑑證明」。",
                docs: [
                    "遺產分割協議書 (正副本各一份，正本需貼印花稅票)",
                    "全體繼承人印鑑證明書 (申辦用途：不動產登記，一年內有效)",
                    "全體繼承人印鑑章",
                    "法院選任特別代理人民事裁定書及確定證明書正本 (若有未成年子女辦理分割繼承)",
                    "特別代理人印鑑證明書及印鑑章 (代表未成年子女於分割協議書簽章用印)"
                ],
                tips: "遺產分割協議書是整件繼承案的核心文件，必須全體繼承人（包含代表未成年子女之特別代理人）蓋印鑑章，印文必須極為清晰，且需與印鑑證明上的圖樣百分之百吻合。協議書正本需依契約金額的千分之一黏貼印花稅票。\n特別注意事項：\n1. 未成年子女特別代理人審查：地政事務所審查分割繼承登記時，會嚴格核對「特別代理人裁定書」與確定證明書，且分割協議書上必須為特別代理人蓋印鑑章。\n2. 未辦保存登記建物：若遺產包含未辦保存登記建物，應至房屋所在地之地方稅稽徵機關辦理「房屋稅納稅義務人名義變更」，檢附 (1)遺產稅免稅/繳清證明書 (2)繼承系統表 (3)遺產分割協議書 (4)法院拋棄繼承/限定繼承備查函。"
            },
            5: {
                title: "第五階段：地方稅查欠",
                shortTitle: "地方稅查欠",
                ...
                tips: "繼承案件本身是免徵土地增值稅及契稅的，但法律規定必須完成「查欠」手續。如果該不動產有欠繳地價稅或房屋稅，必須先行繳清，否則地政事務所會駁回登記申請。有下列情況者，免至戶政事務所申請印鑑證明：(1) 繼承人於產權移轉登記時親自到場，提出身分證正本供登記機關人員核符身分 (2) 遺產分割協議書經依法公證或認證者 (3) 分割協議書經地政士簽證者。"
            },
            6: {
                ...
                time: "3 - 5 工作天",
                agency: "土地所在地之地政事務所",
                desc: "地政士將填妥土地登記申請書及登記清冊，併同前面所有階段取得之除戶謄本、繼承系統表、印鑑證明、遺產稅完稅證明（已蓋查欠戳記）、分割協議書、特別代理人裁定書（如適用）及原權狀等文件，送交地政事務所進行審查。經地政事務所審查無誤並登入地籍資料庫後，發給繼承人全新權狀並結案領狀。",
                docs: [
                    "土地登記申請書及登記清冊 1 份",
                    "載明查欠戳記之遺產稅免稅/繳清/不計入總額/同意移轉證明書正本及影本各 1 份",
                    "被繼承人除戶戶籍資料 1 份及全體繼承人現戶戶籍資料各 1 份",
                    "繼承系統表 1 份",
                    "遺產分割協議書正副本各 1 份 (辦理分割繼承者檢附)",
                    "全體繼承人之印鑑證明 (辦理分割繼承者檢附，注意時效一年內)",
                    "法院選任特別代理人裁定書與確定證明書 (若有未成年子女辦理分割繼承者檢附)",
                    "法院拋棄繼承 / 限定繼承陳報備查函影本或正本 (若有辦理者檢附)",
                    "原土地及建物所有權狀正本"
                ],
        ...
        checklist: [
            {
                ...
                items: [
                    ...
                    "生存配偶隨同辦理身分證換發之照片 (如適用)",
                    "法院開列遺產清冊/限定繼承准予備查裁定 (限定繼承案件)",
                    "法院選任特別代理人裁定書及確定證明書 (未成年子女分割繼承)",
                    "特別代理人印鑑證明書及印鑑章 (未成年子女分割繼承)"
                ]
            },
            {
                group: "二、財產估價與遺產稅文件",
    ...
    gift: {
        ...
        steps: {
            ...
            2: {
                ...
                tips: "公契正本需要按照契約總金額的千分之一「黏貼印花稅票」（可向郵局購買或至地方稅網路申報處開立大額憑證繳款書貼付）。贈與不能申請土地增值稅自用住宅優惠稅率，須按一般稅率辦理。移轉土地若有欠繳地價稅與工程受益費，應於完納後辦理查欠；受益範圍內土地移轉，除因繼承者外，應由買受人出具承諾書承諾繳納未到期工程受益費，或先將工程受益費全部繳清，始得辦理登記。"
            },
            3: {
                title: "第三階段：國稅局贈與稅申報",
                shortTitle: "贈與稅申報",
                ...
                docs: [
                    "贈與稅申報書",
                    "國稅局核發之「遺產及贈與稅免稅/繳清/不計入總額/同意移轉證明書」正本",
                    "贈與契約書影本 (私契/公契影本)",
                    "土地增值稅稅單及契稅稅單影本 (國稅局查核及申報扣除用)",
                    "二親等移轉必備：買受人自立資金來源證明與支付價金金流憑證 (如為申報二親等買賣)",
                    "委任書及代理人身分證明文件"
                ],
                tips: "依遺產及贈與稅法規定，贈與人應自贈與行為發生之次日起「30天內」向國稅局申報贈與稅，逾期申報將處以罰鍰。特別注意：二親等以內親屬間財產買賣，雖免課贈與稅，但仍「必須」向國稅局申報並取得「同意移轉證明書」，地政事務所始得辦理過戶。此外，依遺產及贈與稅法第8條規定，贈與稅未繳清前（或未取得免稅、不計入總額、同意移轉等證明前），不得分割贈與財產或辦理移轉登記。"
            },
            4: {
                ...
                docs: [
                    "已繳清之土地增值稅與契稅繳款書收據正本",
                    "土地贈與及建物贈與公契正本 (供稅捐處加蓋查欠戳記)",
                    "已完稅/免稅之國稅局贈與稅證明書正本"
                ],
                tips: "「查欠」戳記必須蓋在公契正本上。如有歷年欠稅或工程受益費，必須先繳清才能蓋章查欠。無查欠章的地政登記件將會被地政事務所駁回。有下列情況者，免至戶政事務所申請印鑑證明：(1) 贈與人於登記時親自到場，提出身分證正本供登記機關人員核符身分 (2) 契約書經依法公證或認證者 (3) 契約書經地政士簽證者 (4) 贈與人已在登記機關設置土地登記印鑑者。"
            },
            5: {
                ...
                docs: [
                    ...
                    "贈與稅免稅/繳清/同意移轉證明書正本及影本各 1 份",
                    "雙方身分證明文件 (身分證影本或戶口名簿/戶籍資料影本)",
                    "原土地及建物所有權狀正本"
                ],
        ...
        checklist: [
            ...
            },
            {
                ...
                items: [
                    ...
                    "已繳清之土地增值稅及契稅繳款書收據正本",
                    "國稅局贈與稅完稅證明書 (免稅/繳清/不計入總額/同意移轉) 正本"
                ]
            },
            {
                group: "三、地政移轉登記文件",
    ...
    sale: {
        ...
        steps: {
            1: {
                ...
                tips: "地政士在此階段須核對所有權人身分是否屬實，確認有無涉及限制登記（如假扣押、查封、預告登記）。賣方印鑑章之印文必須與印鑑證明完全吻合。有下列情況者，免至戶政事務所申請印鑑證明：(1) 出賣人於產權移轉登記時親自到場，提出身分證正本供登記機關人員核符身分 (2) 契約書經依法公證或認證者 (3) 契約書經地政士簽證者 (4) 出賣人已在登記機關設置土地登記印鑑者。"
            },
            2: {
                title: "第二階段：用印與地方稅申報",
                shortTitle: "用印地方稅申報",
            ...
            3: {
                ...
                tips: "必須繳清歷年欠繳的地價稅與房屋稅才能取得查欠戳記。如果買方需要貸款，本階段應一併協調銀行進行貸款對保及核貸手續。受益範圍內土地移轉，除因繼承外，應由買受人出具承諾書，願依規定繳納未到期之工程受益費，或先將工程受益費全部繳清，始得辦理登記。"
            },
            4: {
            ...
            5: {
                ...
                docs: [
                    "土地/建物登記申請書及登記清冊 1 份",
                    "已蓋查欠完稅戳記之買賣公契正本、印花稅證明",
                    "土地增值稅及契稅繳款書收據正本及影本各 1 份",
                    "賣方印鑑證明、雙方身分證明、原權狀正本",
                    "不動產成交案件實際資訊申報書 (實價登錄申報書，併同送件)"
                ],
                tips: "送件後地政事務所通常審查需要三個工作天。若有缺漏或記載錯誤，地政士必須在收到補正通知15天內完成補正，否則會被駁回。本階段亦須繳付登記費及書狀費。特別注意：買賣移轉登記必須自「買賣契約訂立之日起一個月內」辦理登記，逾期處最高二十倍規費罰鍰。此外，實價登錄依法須在移轉登記時「併同申報」。地政士受託申報若逾期或成交價格申報不實，主管機關將不經限期改正直接裁處新臺幣三萬至十五萬元罰鍰，且可能負刑事責任。"
            },
            6: {
                title: "第六階段：交屋、結案與所得稅申報 (房地合一2.0)",
                shortTitle: "交屋報稅結案",
                time: "3 - 7 工作天",
                agency: "國稅局、買賣不動產現場、地政士事務所",
                desc: "過戶完成後，地政士領取新權狀與他項權利證明。除現場房屋點交、尾款清算外，地政士最重要核心任務是辦理售屋所得稅申報：房地合一2.0新制應於『所有權移轉登記日之次日起算30日內』辦理申報（適用於105年1月1日以後取得之不動產、預售屋、設定地上權之房屋使用權、及特定條件股份交易）；舊制綜合所得稅則併入交易日所屬年度之結算申報期間（翌年5月）辦理。",
                docs: [
                    "新土地所有權狀及新建物所有權狀正本 (買方名義)",
                    "個人房屋土地交易所得稅申報書 (新制適用)",
                    "不動產買入及賣出雙方的買賣契約書影本 (私契)",
                    "收付款價款收付紀錄影本 (匯款憑證、收據等)",
                    "取得成本及必要費用證明文件 (如裝潢發票、仲介費收據、代辦費等)",
                    "所得稅稅額繳納收據正本 (有應納稅額者)",
                    "他項權利證明書及賣方原房地塗銷登記文件 (若賣方有原貸款)"
                ],
                tips: "房地合一2.0申報時限為『所有權移轉登記之次日起算30日內』，預售屋或特定股權出資額交易則為『交易日之次日起算30日內』，逾期申報將面臨新臺幣 3,000 元以上 20,000 元以下罰鍰，並處以漏稅罰。請地政士特別注意：房地合一2.0報稅必須檢附『買、賣雙向私契契約書』及『金流證明（包含全部金流進出憑證）』始得完成申報。交屋完成後，應協助買方申報自用住宅地價稅/房屋稅特別稅率。"
            }
        },
        checklist: [
            {
            ...
            },
            {
                ...
                items: [
                    ...
                    "已繳清之土地增值稅及契稅繳款書收據正本",
                    "土地增值稅及契稅稅單影本 (報稅及地政用)",
                    "買賣交易契約書正影本 (私契，包含當初買入與本次賣出雙向私契)",
                    "價款收付紀錄與金流收據 (存摺明細、匯款單、收付款收據)",
                    "土地及建物第一類登記謄本"
                ]
            },
            {
                ...
                items: [
                    ...
                    "賣方原土地及建物所有權狀正本",
                    "地方稅查欠戳記 (需蓋在公契正本上)",
                    "個人房地合一所得稅申報書與取得成本/費用單據",
                    "他項權利設定/塗銷登記文件 (他項權利證明書、債務清償證明)",
